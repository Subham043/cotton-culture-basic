...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Categories', 'page_link'=>route('category_list.get'), 'list'=>['Create']])
        <!-- end page title -->

        <div class="row">
            @include('admin.includes.back_button', ['link'=>route('category_list.get')])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('category_create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
