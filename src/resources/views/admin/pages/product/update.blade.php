...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Products', 'page_link'=>route('product_list.get'), 'list'=>['Update']])
        <!-- end page title -->

        <div class="row">
            @include('admin.includes.back_button', ['link'=>route('product_list.get')])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('product_update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                            ...
                            <div class="live-preview">
                                <div class="row gy-4">
                                    <div class="col-xxl-4 col-md-4">
                                        @include('admin.includes.input', ['key'=>'name', 'label'=>'Product Name', 'value'=>$data->name])
                                    </div>
                                    <div class="col-xxl-4 col-md-4">
                                        <div>
                                    ...
                                    <div class="col-xxl-12 col-md-12">
                                        @include('admin.includes.quill', ['key'=>'description', 'label'=>'Product Description', 'value'=>$data->description])
                                    </div>
