                ...
                <div id="scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link {{strpos(url()->current(),route('product_list.get')) !== false ? 'active' : ''}}" href="{{route('product_list.get')}}">
                                    <i class="ri-gift-line"></i> <span data-key="t-widgets">Products</span>
                                </a>
                            </li>
                            {{-- <li class="nav-item">
